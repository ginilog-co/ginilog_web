...
class PaymentMethodWidget2 extends ConsumerStatefulWidget {
  const PaymentMethodWidget2({
    super.key,
  ...
  final String stationId, addressId, phoneNo;
...
class _PaymentMethodWidgetState extends ConsumerState<PaymentMethodWidget2>
  ...
  Future<void> handleFlutterWavePayment() async {
    ...
    if (response.status == "completed") {
      ...
      // await PackageOrderService().createOrder(
      //   companyId: widget.stationId,
      //   packageInputkg: widget.gasInputkg,
