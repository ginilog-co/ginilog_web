...
import 'package:ginilog_customer_app/core/features/account/view/report/view_order_receipt.dart';
import 'package:ginilog_customer_app/core/features/order_history/model/package_orders_model.dart';

class OrderItemPage extends ConsumerStatefulWidget {
  final PackageOrderResponseModel order;
  const OrderItemPage({super.key, required this.order});

  @override
  ConsumerState<OrderItemPage> createState() => _OrderItemPageState();
}
