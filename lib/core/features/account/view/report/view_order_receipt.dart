...
class ViewOrderPackageReceiptPage extends ConsumerStatefulWidget {
  final PackageOrderResponseModel order;
  const ViewOrderPackageReceiptPage({super.key, required this.order});

  @override
  ConsumerState<ViewOrderPackageReceiptPage> createState() =>
      _ViewOrderPackageReceiptPageState();
}

class _ViewOrderPackageReceiptPageState
    extends ConsumerState<ViewOrderPackageReceiptPage> {
