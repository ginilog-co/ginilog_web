...
class CustomerBookResponseModel {
  ...
  factory CustomerBookResponseModel.fromJson(Map<String, dynamic> json) =>
      CustomerBookResponseModel(
        id: json["id"],
        ...
        reservationStartDate: json["reservationStartDate"],
        reservationEndDate: json["reservationEndDate"],
        noOfDays: json["noOfDays"],
        ticketClosed: json["ticketClosed"],
        totalCost: json["totalCost"],
        updateddAt: json["updateddAt"] == null
            ? null
            : DateTime.parse(json["updateddAt"]),
