// app/brand-owner/adverts/page.tsx
"use client";
...
import { getAllAdverts, deleteAdvert } from "@/lib/api";

export default function BrandOwnerAdvertsPage() {
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">Manage your promotional content</p>
        </div>
        <Button onClick={() => router.push("/brand-owner/adverts/add")} className="gap-2">
      ...
      {filteredAdverts.length === 0 ? (
        <Card>
          <CardContent className="text-center py-12">
            ...
            <Button className="mt-4" onClick={() => router.push("/brand-owner/adverts/add")}>
            ...
            <Card key={advert.id} className="overflow-hidden hover:shadow-md transition-shadow">
              ...
              <CardContent className="p-4">
                ...
                <div className="flex gap-2 mt-4">
                  <Link href={`/brand-owner/adverts/${advert.id}`} className="flex-1">
                    <Button size="sm" variant="outline" className="w-full">
                      <Eye className="h-3 w-3 mr-1" /> View
                    </Button>
                  </Link>
                  <Link href={`/brand-owner/adverts/${advert.id}/edit`} className="flex-1">
                    <Button size="sm" variant="outline" className="w-full">
