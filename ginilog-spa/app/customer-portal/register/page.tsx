            ...
            {step === 1 ? (
              ...
              <div className="space-y-6">
                <div className="text-center">
                  <h2 className="text-xl font-semibold text-gray-900 mb-2">What brings you to GINILOG?</h2>
                  <p className="text-gray-600 text-sm">Select how you plan to use our platform</p>
                </div>

                <div className="grid grid-cols-1 gap-4">
                  {/* Accommodation Option */}
                  <button
                    onClick={() => handleUserTypeSelect("accommodation")}
                    className="group relative p-6 border-2 border-gray-200 rounded-xl hover:border-primary hover:bg-red-50 transition-all text-left"
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-1">Accommodation Customer</h3>
                        <p className="text-sm text-gray-600">
                          Book hotels, apartments, and resorts for your stays. Find comfortable accommodations near you.
                        </p>
                      </div>
                    </div>
                  </button>
                  ...
                  {/* Logistics Option */}
                  <button
                    onClick={() => handleUserTypeSelect("logistics")}
                    className="group relative p-6 border-2 border-gray-200 rounded-xl hover:border-primary hover:bg-red-50 transition-all text-left"
                  >
                    <div className="flex items-start gap-4">
                      <div className="p-3 bg-primary/10 rounded-lg group-hover:bg-primary/20">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-1">Logistics Customer</h3>
                        <p className="text-sm text-gray-600">
                          Send packages, track deliveries, and manage your logistics needs with trusted partners.
                        </p>
                      </div>
                    </div>
                  </button>
                ...
                <p className="text-xs text-center text-gray-500">
                  You can change your preferences later in your profile settings
                </p>
              </div>
            ) : (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm text-primary capitalize">{userType} Registration</span>
                </div>
